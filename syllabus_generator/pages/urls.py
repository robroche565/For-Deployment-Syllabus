...
urlpatterns = [
    ...
    path('forgot_password/sent', views.forgot_pass_confirm_sent_view, name='forgot_password_sent'),
    ...
    path('submit_forgot_password/', views.ForgotPasswordSubmitView.as_view(), name='submit_forgot_password'),
    path('forgot_password/success/', views.success_reset_view, name='success_reset_password'),

    path('verification/send', views.send_verif_view, name='send_verification'),
    path('verification/verify/<uidb64>/<token>/', views.verify_email, name='verify_email'),
    path('verification/sent', views.sent_verif_success_view, name='sent_verification'),
